      ...
      <CardContent className="flex-1 overflow-y-auto pr-2 -mr-2">
        <div className="space-y-4">
          {data.feeds.slice(0, 4).map((feed) => (
            <div key={feed.id} className="flex items-center gap-3 border-b border-border pb-3 last:border-0 last:pb-0">
              ...
              <div className="flex flex-col items-end flex-shrink-0 pr-3">
                {feed.status === 'active' ? (
                ...
                <span className="text-xs text-muted-foreground mt-0.5 whitespace-nowrap tabular-nums">
